...
from tmaprocessor.models.tma_ops._tma_model import TMAMasker
from tmaprocessor.widgets._tma_ops_widget import TMAMaskerNapariWidget
...
def test_update_model(viewer_and_image_layer_with_spatialdata):
    ...
    assert widget._generate_masks_button.enabled == True
